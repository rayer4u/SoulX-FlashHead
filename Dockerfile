...
RUN uv pip install flash_attn-2.8.3+cu12torch2.8cxx11abiTRUE-cp311-cp311-linux_x86_64.whl
COPY ./ /workspace/

#monkey hack
RUN sed -i 's/2.8.3/2.8.2/g' /workspace/.venv/lib/python3.11/site-packages/flash_attn/__init__.py
